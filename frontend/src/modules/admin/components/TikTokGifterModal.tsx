...
export function TikTokGifterModal({
  ...
  // Embedded mode: this modal sits inside `TikTokGifterDetailModal`'s
  // Current tab. Identity-level actions (Favourites, Add-to-monitor)
  // belong on the Profile tab — that tab's about the PERSON across
  // every live they've gifted in, not this session in particular.
  // So embedded mode here returns just the body, no action footer.
